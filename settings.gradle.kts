...
include(":data:fact:translated:impl:retrofit:ya:translator")
include(":ui:breeds")
include(":feat:breeds")
...
include(":data:breed:translated:impl:retrofit:ya:translator")
include(":feat:favourite")
include(":data:retrofit:libretranslate")
include(":data:fact:translated:impl:retrofit:libretranslate")
include(":data:breed:translated:impl:retrofit:libretranslate")
